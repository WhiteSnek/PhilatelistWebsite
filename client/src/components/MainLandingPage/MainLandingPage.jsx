...
import stamp5 from '../../assets/stamps/stamp5.jpg'
import stamp6 from '../../assets/stamps/stamp6.jpg'
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      >
        <img
          ...
          alt="landing-page"
        />
        <div className="absolute inset-0 py-10 lg:py-20 bg-black opacity-70 px-10 lg:px-16">
      ...
      <section className="p-8 max-w-7xl mx-auto">
        <h3 className="text-4xl font-bold mb-4 text-gray-800">Featured Collections</h3>
        <motion.div 
        ...
        >
          {products.map((collection, idx) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h4 className="text-lg font-bold text-gray-800">{collection.state}</h4>
              </div>
            </motion.div>
          ))}
        </motion.div>
      ...
      <section className="p-8 max-w-7xl mx-auto">
        <h3 className="text-2xl font-bold mb-4 text-gray-800">Top Picks by Collectors</h3>
        <motion.div
        ...
        >
          {products.map((item, index) => (
            ...
            >
              <a href="#">
                <img className="p-8 rounded-t-lg h-60 w-96" src={item.image} alt="product image" />
              </a>
              <div className="px-5 pb-5">
                <a href="#">
                  <h5 className="text-xl font-semibold tracking-tight text-gray-900">{item.description}</h5>
                </a>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5">Know more</a>
                </div>
              </div>
            </motion.div>
          ))}
